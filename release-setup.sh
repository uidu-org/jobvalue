...
git push https://${GH_TOKEN}@github.com/uidu-org/jobvalue.git HEAD:master > /dev/null 2>&1
echo -e "\e[32m Setting git configs..."
yarn build:pkg
echo -e "\e[32m Setting git configs..."
yarn changeset publish --otp=$NPM_TOKEN
echo -e "\e[32m Setting git configs..."
git push https://${GH_TOKEN}@github.com/uidu-org/jobvalue.git --tags > /dev/null 2>&1
echo -e "\e[32m Setting git configs..."
